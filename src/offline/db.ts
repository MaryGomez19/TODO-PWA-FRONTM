...
export async function chacheTasks(list:any[]){
...
export async function deleteTaskLocal(id: string){ await ((await db()).delete("tasks", id)); }

//ClienteID para que el servidor detecte al cliente
...
//autobox para sincronizar cambios cuando haya conexión
